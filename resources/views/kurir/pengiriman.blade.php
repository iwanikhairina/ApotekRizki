...
<div class="page-header">
    ...
    <p>Pesanan yang sedang kamu antar saat ini</p>
</div>
...
@if ($pesanan)
    ...
    <div class="wrapper">
        <div class="timer-box" id="timerBox">
            ...
            <div class="timer-sub">Berdasarkan jarak {{ $pesanan->jarak_km ?? '-' }} km dari apotek</div>
        </div>
    </div>
        ...
        <div class="sticky-col">
            ...
            <div class="card">
                <div class="action-buttons">
                    ...
                    <button type="button" class="btn-batal" onclick="document.getElementById('batalModal').classList.add('open')">✕ Batalkan</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-box">
            ...
            <form method="POST" action="{{ route('kurir.pengiriman.batal', $pesanan->id) }}">
                ...
                <div class="modal-buttons">
                    ...
                    <button type="submit" class="btn-modal-confirm">Kirim & Batalkan</button>
                </div>
            </form>
        </div>
    </div>
...
@else
    <div class="empty-state">Tidak ada pengiriman yang sedang berlangsung. Ambil pesanan baru di menu Pesanan.</div>
@endif
@endsection
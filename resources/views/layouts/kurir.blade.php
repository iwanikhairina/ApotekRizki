...
<nav class="navbar">
    <div class="navbar-inner">
        <a href="{{ route('kurir.dashboard') }}" class="brand">
            <img src="{{ asset('assets/images/logo-apotekrizki.png') }}" alt="Logo Apotek Rizki">
            <span>
                Apotek Rizki
                <small>Panel Kurir</small>
            </span>
        </a>

        <ul class="nav-links" id="navLinks">
    <li><a href="{{ route('kurir.dashboard') }}" class="{{ request()->routeIs('kurir.dashboard') ? 'active' : '' }}">
    ...
    <li><a href="{{ route('kurir.pesanan') }}" class="{{ request()->routeIs('kurir.pesanan*') ? 'active' : '' }}">
    ...
    <li><a href="{{ route('kurir.pengiriman') }}" class="{{ request()->routeIs('kurir.pengiriman*') ? 'active' : '' }}">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="5.5" cy="17.5" r="2.5"/><circle cx="18.5" cy="17.5" r="2.5"/><path d="M15 17.5H9M1 17.5V6a1 1 0 0 1 1-1h11l5 5v7.5h-2"/></svg>
        Pengiriman
    </a></li>
    <li><a href="{{ route('kurir.riwayat') }}" class="{{ request()->routeIs('kurir.riwayat*') ? 'active' : '' }}">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/><path d="M12 7v5l3 3"/></svg>
        Riwayat Pengiriman
    </a></li>
    <li><a href="{{ route('kurir.profil') }}" class="{{ request()->routeIs('kurir.profil') ? 'active' : '' }}">
        ...
        <div class="nav-right">
            <div class="user-chip">
                <div class="avatar">{{ strtoupper(substr(auth()->user()->name ?? 'K', 0, 1)) }}</div>
                <span>{{ auth()->user()->name ?? 'Kurir' }}</span>
            </div>

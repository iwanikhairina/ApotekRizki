...
<div class="page-header">
    <h1>Selamat datang, {{ auth()->user()->name ?? 'Apoteker' }} 👋</h1>
    <p>Berikut ringkasan aktivitas apotek hari ini, {{ \Carbon\Carbon::now()->translatedFormat('l, d F Y') }}</p>
</div>
...
<div style="background:#fff1f0;border:1px solid #ffccc7;color:#cf1322;padding:12px 16px;border-radius:12px;font-size:13.5px;margin-bottom:24px;font-weight:600;">
    ⚠ Kamu sedang di luar jam shift, sehingga tidak bisa memproses pesanan atau memverifikasi resep sampai jadwal shift kamu dimulai kembali.
</div>
@endif
...
<div class="stat-grid">
    <div class="stat-card green">
        ...
        <div class="stat-value">{{ $totalPesananHariIni }}</div>
    ...
    <div class="stat-card blue">
        <div class="stat-icon">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/><path d="M12 7v5l3 3"/></svg>
        </div>
